  ...
  void run()
  {
    ...
    while ( 1 ) {
      ...
      try {
        ...
        std::cout << "beam : " << radianToDegree( audio.getBeamAngle() ) <<
          ", angle : " << radianToDegree( audio.getSoundSourceAngle() ) <<
          ", confidence : " << audio.getSoundSourceAngleConfidence() << "\n";
